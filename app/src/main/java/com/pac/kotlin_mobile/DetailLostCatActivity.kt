...
class DetailLostCatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.address.text="บ้านเลขที่ : ${search?.house_no} ถนน : ${search?.street} ตำบล : ${search?.sub_district} เขต/อำเภอ : ${search?.district} จังหวัด : ${search?.province} รหัสไปรษณีย์ : ${search?.post_address}"
